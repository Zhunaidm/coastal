...
public class Instrumenter {
    ...
    public static void instrument(String inputClassName, String outputClassName) {
        ...
        FileOutputStream fos = new FileOutputStream(outputClassName);
...
class MethodAdapter extends LocalVariablesSorter implements Opcodes {
    ...
    public void visitJumpInsn(int opcode, Label label) {
        ...
        mv.visitMethodInsn(INVOKESTATIC, "za/ac/sun/cs/coastal/Data", "addTuple", "(Ljava/lang/String;Ljava/lang/String;)V", false);
